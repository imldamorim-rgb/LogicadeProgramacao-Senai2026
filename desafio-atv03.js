...
let cadastro = {
    nome: lerTudo.question('Nome: '),
    idade: lerTudo.questionInt('Idade: '),
    profissao: lerTudo.question('Profissao: '),
    cidade: lerTudo.question('cidade: '),
    javaScript: lerTudo.keyInYN('Voce gosta de programar em JS?'),
        comidaFavorita1: [
        lerTudo.question('Infome suas comidas favoritas: '),
    ],
        pessoaMora: {
        nomePessoa: lerTudo.question('Nome da pessoa com que mora: '),
        idadePessoa: lerTudo.questionInt('Idade da pessoa com quem mora: '),
    },
};

console.table(cadastro)

console.log(`Nome: ${cadastro.nome}. Idade: ${cadastro.idade} anos. Profissão: ${cadastro.profissao} em ${cadastro.cidade}. Gosta de JS: ${cadastro.javaScript}. Comidas favoritas: ${cadastro.comidaFavorita1}. Com quem mora: ${cadastro.pessoaMora}.`)
