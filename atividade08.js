...
// let turno = lerTudo.questionInt(`Escolha um turno: `)
...
// // → Seu código aqui:
// let estacao = lerTudo.question(`Qual a sua estação do ano favorita: `)
...
// // → Seu código aqui:
// let numero = lerTudo.questionInt(`Escolha um número de 1 a 7: `)
...
// let produto = {
//     nome: lerTudo.question(`Digite seu nome: `),
//     categoria: lerTudo.questionInt(`Escolha uma categoria:`),
//     preco: lerTudo.questionFloat(`Digite o preço do produto: `)
// }
...
//         produto.categoria = "Sem garantia"
// }
...
// let usuario = {
//     nome: lerTudo.question(`Digite seu nome: `),
//     nota: lerTudo.questionInt(`Digite sua nota (1 a 10): `)
// }
...
// → Seu código aqui:
let num1 = lerTudo.questionFloat(`Digite o primeiro número: `)
let num2 = lerTudo.questionFloat(`Digite o segundo número: `)

console.log("MENU DE OPERAÇÃO");
console.log("1 – Soma");
...
let operação = lerTudo.questionFloat(`Digite o número da operação desejada: `)
...
// c) 
let opcao = lerTudo.questionInt("Escolha uma opção: ");
...
switch (opcao) {
  case 1:
    console.table([
      ...
      { produto: "Fone", preco: 199.90 }
    ]);
    break;

  case 2:
    let produto = lerTudo.question("Nome do produto: ");
    let preco = lerTudo.questionFloat("Preço: ");
    loja.saldo += preco;
