...
let tudo = require(`readline-sync`)

let secreta = 'JavaScript'
let tentativa = 0

while(true){
    let palpite = tudo.question(`Faça um palpite: `)
    tentativa++
...
while(true){
    let numero = tudo.questionFloat(`Digite um número (0 para sair):  `)
...
let media = totalVendas / qtdVendas;

console.log(`
Vendas válidas: ${qtdVendas}.
Total arrecadados: ${totalVendas}.
Ticket médio: ${media}
`)
...
for(let i = 1; i <= 50; i++){
    ...
    soma1 += i
    console.log(`Somando: ${i} | Acumulado: ${soma1}`);
...
console.log(`Laço encerrado em i = ${iFinal} | Soma final: ${soma1}`)
