...
do {
    nome = lerQuiz.question("Nome do viajante: ").trim();

    if (nome === "") {
        console.log("É necessário adicionar um nome. Tente novamente.");
    }
...
let orcamento = lerQuiz.questionInt(`
1) Econômico                          
2) Moderado 
3) Luxo" 
...
switch(resp1) {
    case 1:
        ...
        break;
        //na linha abaixo(182) acho que seria interessante colocar a pergunta de fato, para ficar mais claro para o usuario
        // não entendi qual seria a pergunta propsta, apenas coloquei o que estava no enunciado (foi alterado do mesmo jeito)
    case 2:
        console.log(`Você prefere:              
        1) Neve de verdade
        2) Frio sem neve`);
...
//Revisão final: apenas observado detalhes estruturais, o código em si esta rodando certinho, muito bem! :)
// na sujestão da organização da linhas a partir do codigo que abriga as respostas para as resp1(182) foi corrigido, porém acredito que seria melhor colocar ao inicio, pois no terminal fica estranho a posição.