...
//
let frase1 = `Olá, meu nome é ${nome1}, eu tenho ${idade1} anos e o meu hobby favorito nas horas vagas é ${hooby1}.`
//
console.log(frase1)
...
let temperatura1 = 21
//
let frase2 = `Hoje em ${cidade1} está fazendo ${temperatura1}°C, perfeito para dar um passeio.`
//
console.log(frase2)
console.log("_______________________________");
...
let erro = null 
//
let fraseString = `Estou aprendendo ${string} e o tipo é ${typeof string}.`
let fraseNumber = `Hoje é dia ${number} de Março e o tipo é ${typeof number}.`
let fraseBoolean = `Amanhã é 2030: ${boolean} e o tipo é ${typeof boolean}.`
let fraseUndefined = `O valor é ${undefined} e o tipo é ${typeof undefined}`
let fraseErro = `O valor é ${erro} e o tipo é ${typeof erro}.`
//
...
//
let frase3 = `${personagem1} é uma moça de ${idade2} anos, sempre sonhou em ir para ${cidade2} e lá tinha apenas uma missão: ${missão1}.`
//
console.log(frase3)
...
//
let frase4 = `Eu, ${nome2}, acredito que com motivação e dedicação ao fim do ano eu possa ter ${objetivo1}. `
//
console.log(frase4)
